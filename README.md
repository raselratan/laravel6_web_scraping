...
<ul>
	<li>
		package source:  https://packagist.org/packages/guzzlehttp/guzzle
		<ul>
			<li>
	...
	<li>
		package source:  https://packagist.org/packages/sunra/php-simple-html-dom-parser
		<ul>
			<li>
				run composer require sunra/php-simple-html-dom-parser
			</li>
		</ul>
	</li>	
</ul>
